...
<body>
    ...
    <div class="row" id="content">
        <div class="mx-auto col-10 col-md-8 col-lg-6">
            <form METHOD="POST" id="form_editar" action="editarUsuario_action.php">
                ...
                <div class="checkbox col-md-6 mb-3 container row">
                    <label>
                        <input type="checkbox" name="role" value="1" id="role" <?= ($usuario['role'] == 'admin') ? "checked" : "" ?>> Administrador
                    </label>
                    <label>
                        <input type="checkbox" name="ativo" value="1" id="ativo" <?= ($usuario['ativo'] == 1) ? "checked" : "" ?>> Ativo
                    </label>
                </div>
